...
![相関IDのイメージ（一本の糸で繋ぐ）](./picture/cap_ts_study_030_correlation_id.png)
...
sequenceDiagram
    ...
    Note over C,W: Correlation ID: order-123 (不変の糸 🧵)
    ...
    Note right of A: Request ID: req-001
    Note right of W: Request ID: job-456
```
