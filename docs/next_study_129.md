...
![イメージ図](./picture/next_study_129_logging.png)

```mermaid
flowchart LR
  U["Browser"] --> M["Middleware<br/>入口の門番🧤"]
  M -->|"通す"| P["Page / RSC<br/>表示🧊"]
  M -->|"止める"| L["Redirect / Block<br/>ログ残す🚦"]
  P --> A["Route Handler / Server Actions<br/>処理📡"]
  A --> R["Response"]
  R --> U
```
