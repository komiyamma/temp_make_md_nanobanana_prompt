...
![集約の境界](./picture/es_cs_study_010_aggregate_boundary.png)

Aggregate（集約）は、ざっくり言うと…

```mermaid
graph TD
    subgraph Aggregate_Island ["集約の境界 (Aggregate Boundary)"]
        Root[Aggregate Root 🚪<br/>整合性の番人]
        Child1[子要素 🧸]
        Child2[子要素 🧸]
    ...
    User((ユーザー)) -- "Root経由で命令" --> Root
    Root -- "不変条件を守る" --> Aggregate_Island
```
...
![Boundary Decision Roadmap](./picture/es_cs_study_010_boundary_roadmap.png)
...
![Aggregate Root Gatekeeper](./picture/es_cs_study_010_root_gatekeeper.png)
...
![Aggregate Size Comparison](./picture/es_cs_study_010_cart_vs_inventory.png)
...
![Comparison Chart](./picture/es_cs_study_010_comparison_chart.png)
...
![Event Streams](./picture/es_cs_study_010_stream_per_aggregate.png)
...
graph LR
    ...
    S1 --> E11[Created] --> E12[Added] --> E13[Paid]
    S2 --> E21[Created] --> E22[Added]
    S3 --> E31[Registered] --> E32[ProfileUpdated]
```
...
![Code Structure Castle](./picture/es_cs_study_010_code_castle.png)
...
![Bloated Root Mistake](./picture/es_cs_study_010_bloated_root.png)
