...
![Event vs State Metaphor](./picture/es_cs_study_011_event_vs_state.png)
...
![状態遷移図](./picture/es_cs_study_011_state_transition.png)

```mermaid
stateDiagram-v2
    [*] --> NotCreated
    NotCreated --> Active: CartCreated
    Active --> Active: ItemAdded / ItemRemoved
    Active --> CheckedOut: CheckedOut
    Active --> Cancelled: CartCancelled
    CheckedOut --> [*]
    Cancelled --> [*]
```
...
![Simple Transition](./picture/es_cs_study_011_simple_arrows.png)
...
![Transition Guard](./picture/es_cs_study_011_transition_guard.png)
...
![Transition Matrix](./picture/es_cs_study_011_matrix_clipboard.png)

```mermaid
graph TD
    NC[NotCreated] -- CartCreated --> A[Active]
    A -- ItemAdded/Removed --> A
    A -- CheckedOut --> CO[CheckedOut]
    A -- CartCancelled --> C[Cancelled]
    
    CO -- 禁止: ItemAdded --> Error1[例外/無視]
    C -- 禁止: ItemAdded --> Error2[例外/無視]
    
    style NC fill:#f5f5f5
    style A fill:#e1f5fe
...
![Missing Event Detection](./picture/es_cs_study_011_missing_puzzle.png)
...
![Blueprint to Code](./picture/es_cs_study_011_blueprint_to_code.png)
...
![Exercise Sheet](./picture/es_cs_study_011_student_exercise.png)
