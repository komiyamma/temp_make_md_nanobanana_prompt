...
## 2) 「普通に作る」と、こうなる😇➡️😵
![Manual Backend vs BaaS Workload](./picture/react_study_192_manual_vs_baas.png)
...
![BaaSアーキテクチャ](./picture/react_study_192_baas.png)
...
![Supabase vs Firebase Comparison](./picture/react_study_192_supabase_vs_firebase.png)
...
![API Key Security Rule](./picture/react_study_192_key_security.png)
