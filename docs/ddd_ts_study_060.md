...
```mermaid
quadrantChart
    title Rule Classification Map
    x-axis "Single Object" --> "Multi/Complex"
    y-axis "Data Format" --> "Business Logic"
    
    quadrant-1 "Aggregate 🏯"
    quadrant-2 "Value Object 💎"
    quadrant-3 "UI / Validation ⌨️"
    quadrant-4 "Application Service 🎬"
    
    "Money / Quantity": [0.2, 0.8]
    "Email Format": [0.15, 0.2]
    "Order Invariants": [0.8, 0.9]
    "Save Flow": [0.8, 0.3]
```
