...
![react_study_002_01_components](./picture/react_study_002_01_components.png)

**状態（state）**＝「画面が覚えてる値」🧠
たとえば「ログイン中か」「読み込み中か」「入力フォームの中身」みたいなやつです。
状態が変わると、Reactがいい感じに画面を更新します🔁✨

![react_study_002_02_state](./picture/react_study_002_02_state.png)
...
![react_study_002_03_vite_setup](./picture/react_study_002_03_vite_setup.png)
...
![react_study_002_04_hmr](./picture/react_study_002_04_hmr.png)
...
![react_study_002_05_ai_help](./picture/react_study_002_05_ai_help.png)
...
![react_study_002_06_troubleshoot](./picture/react_study_002_06_troubleshoot.png)
