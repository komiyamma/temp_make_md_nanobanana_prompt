...
sequenceDiagram
    ...
    Client->>App: Execute (Command/DTO)
    
    rect rgb(240, 248, 255)
        note right of App: 1. Input Validation 📝
    end
    ...
    rect rgb(255, 250, 240)
        note right of App: 2. Sort out procedure 🎬
        App->>Domain: Call Method
        Domain-->>Domain: Check Rules 🔒
    end

    App->>Repo: Save
    
    rect rgb(240, 255, 240)
        note right of App: 3. Return DTO 🎁
    end
    
    App-->>Client: Result/DTO
```
