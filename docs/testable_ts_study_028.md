...
## 28-1. まず大前提：ログは “外の世界” に出る＝I/O だよ📣🌍

![testable_ts_study_028_logs_are_io.png](./picture/testable_ts_study_028_logs_are_io.png)ログって「画面に出すだけ」っぽく見えるけど、実際は…
...
![testable_ts_study_028_good_log_anatomy.png](./picture/testable_ts_study_028_good_log_anatomy.png)
...
![testable_ts_study_028_correlation_id_thread.png](./picture/testable_ts_study_028_correlation_id_thread.png)
...
![testable_ts_study_028_logger_injection_pattern.png](./picture/testable_ts_study_028_logger_injection_pattern.png)
...
## 28-4. Loggerを “最小の約束” にする📜✨

![testable_ts_study_028_logger_interface_contract.png](./picture/testable_ts_study_028_logger_interface_contract.png)### ① まず型を決める（イベント中心）
...
## 28-6. 外側：Pinoで “本番のLogger” を作る🚀🧰

![testable_ts_study_028_pino_structure.png](./picture/testable_ts_study_028_pino_structure.png)Node/TypeScript界隈だと **Pino** は「速い・構造化しやすい」で定番寄りだよ📌 ([getpino.io][2])
...
![testable_ts_study_028_log_verification_check.png](./picture/testable_ts_study_028_log_verification_check.png)
