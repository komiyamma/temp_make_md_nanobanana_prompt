...
![RHFとZodの連携](./picture/react_study_185_rhf_zod.png)
...
![react study 185 resolver bridge](./picture/react_study_185_resolver_bridge.png)

### 1) Zodで「入力ルール」を作る 🧩

![react study 185 infer magic](./picture/react_study_185_infer_magic.png)
