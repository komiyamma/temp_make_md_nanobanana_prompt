...
![Alpine Warning](./picture/docker_runtime_fix_ts_study_015_01_alpine_warning.png)
...
![Safe vs Risky Path](./picture/docker_runtime_fix_ts_study_015_02_safe_path.png)
...
![Tool Completeness](./picture/docker_runtime_fix_ts_study_015_03_tool_completeness.png)

### 地雷①：`musl` と `glibc` の違いで「動くはずが動かない」🤯

![Three Pitfalls](./picture/docker_runtime_fix_ts_study_015_04_three_pitfalls.png)
...
![Size Inflation](./picture/docker_runtime_fix_ts_study_015_05_size_inflation.png)
...
![Alpine License Checklist](./picture/docker_runtime_fix_ts_study_015_06_checklist_license.png)
...
![Alpine Survival Kit](./picture/docker_runtime_fix_ts_study_015_07_survival_kit.png)
