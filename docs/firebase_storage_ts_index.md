...
![App Goal Wireframe](./picture/firebase_storage_ts_index_03_app_goal.png)
...
![Course Roadmap](./picture/firebase_storage_ts_index_02_roadmap.png)

## Part A：まず動かす（「アップロードできた！」まで）🚀

### 第1章：Storageって何？画像はどこに置かれる？📦

![Storage Metaphor](./picture/firebase_storage_ts_index_01_warehouse.png)
...
![Blob vs File](./picture/firebase_storage_ts_index_04_blob_vs_file.png)
...
![Reference Concept](./picture/firebase_storage_ts_index_05_ref_concept.png)
...
![Security Rules Gatekeeper](./picture/firebase_storage_ts_index_06_security_rules.png)
...
![AI Integration](./picture/firebase_storage_ts_index_07_ai_integration.png)
