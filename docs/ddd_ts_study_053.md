...
graph TD
    ...
    Rule -- Yes --> Same["同じ集約にする🏯<br/>(Strong Consistency)"]
    Rule -- No --> Diff["別の集約にする🌍<br/>(Eventual Consistency)"]
    
    subgraph Ex_OrderPayment
    Same --> |明細追加と合計計算| OrderAgg[Order Aggregate]
    Diff --> |支払完了とレシート発行| ReceiptAgg[Receipt Aggregate]
    end
```
...
![ddd_ts_study_053_invariant_lock](./picture/ddd_ts_study_053_invariant_lock.png)
...
![ddd_ts_study_053_sync_vs_async](./picture/ddd_ts_study_053_sync_vs_async.png)
...
![ddd_ts_study_053_order_boundary](./picture/ddd_ts_study_053_order_boundary.png)
...
![ddd_ts_study_053_payment_separation](./picture/ddd_ts_study_053_payment_separation.png)
...
![ddd_ts_study_053_code_map](./picture/ddd_ts_study_053_code_map.png)
