...
![ddd ts study 058 test goals](./picture/ddd_ts_study_058_test_goals.png)
...
![ddd ts study 058 public method test](./picture/ddd_ts_study_058_public_method_test.png)
...
flowchart LR
    ...
    subgraph Aggregate Boundary [Aggregate Boundary 🏯]
        Root[👑 Root Methods]
        Internal[🚫 Internal State]
    end

    Test -->|Call| Root
    Root -->|Update| Internal
    Test --x|Access Denied| Internal
    Root -->|Return| Test

    style Internal fill:#eee,stroke:#999,stroke-dasharray: 5 5
```
...
![ddd ts study 058 fixture factory](./picture/ddd_ts_study_058_fixture_factory.png)
...
![ddd ts study 058 parameterized test](./picture/ddd_ts_study_058_parameterized_test.png)
...
![ddd ts study 058 fake timer](./picture/ddd_ts_study_058_fake_timer.png)
...
![ddd ts study 058 ai test cases](./picture/ddd_ts_study_058_ai_test_cases.png)
