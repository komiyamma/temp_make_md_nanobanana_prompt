...
![useDebugValueのイメージ](./picture/react_study_138_usedebugvalue.png)
...
```mermaid
flowchart LR
  Component["コンポーネント<br>(ToggleDemo など)"]
  Hook["カスタムフック<br>useToggle / useWindowSize<br>(中で useDebugValue を呼ぶ)"]
  DevTools["React DevTools<br>(Hooks タブ)"]
