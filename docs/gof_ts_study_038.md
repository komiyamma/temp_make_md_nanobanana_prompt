...
## ありがちな“汚れ方”あるある😵‍💫
![dirty_patterns](./picture/gof_ts_study_038_dirty_patterns.png)
...
## 境界の“掃除チェックリスト”🧹✅
![checklist](./picture/gof_ts_study_038_checklist.png)
...
### 5) 変換しないこと🙅‍♀️
![sequence](./picture/gof_ts_study_038_sequence.png)
...
![normalization](./picture/gof_ts_study_038_normalization.png)
...
![satisfies](./picture/gof_ts_study_038_satisfies.png)
...
## レビュー観点👀✨（“境界が守れてる？”チェック）
![review](./picture/gof_ts_study_038_review.png)
...
## つまずき回避💡🌸
![pitfalls](./picture/gof_ts_study_038_pitfalls.png)
