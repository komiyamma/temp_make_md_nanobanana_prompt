...
graph TD;
  ...
  B --> C["Route<br/>path=#quot;/#quot; → HomePage"];
  B --> D["Route<br/>path=#quot;/about#quot; → AboutPage"];
  B --> E["Route<br/>path=#quot;/contact#quot; → ContactPage"];
```

![RoutesとRouteのイメージ](./picture/react_study_144_routes_route.png)
