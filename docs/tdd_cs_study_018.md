...
![画像を挿入予定](./picture/tdd_cs_study_018_cafe_counter.png)

**カフェ会計**の合計金額（円）を出すだけ☕️

* 注文は「明細の配列（複数OK）」

![画像を挿入予定](./picture/tdd_cs_study_018_minimal_spec.png)
...
![画像を挿入予定](./picture/tdd_cs_study_018_red_state.png)
...
![画像を挿入予定](./picture/tdd_cs_study_018_green_state.png)
...
![画像を挿入予定](./picture/tdd_cs_study_018_rounding_rule.png)
...
![画像を挿入予定](./picture/tdd_cs_study_018_refactor_split.png)
...
![画像を挿入予定](./picture/tdd_cs_study_018_commit_steps.png)
