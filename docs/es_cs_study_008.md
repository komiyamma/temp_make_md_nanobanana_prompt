...
![Naming Rules Mindmap](./picture/es_cs_study_008_naming_mindmap.png)
...
![過去形での命名](./picture/es_cs_study_008_past_tense.png)
...
![Granularity Scale](./picture/es_cs_study_008_granularity_scale.png)

```mermaid
graph LR
    Big[でかすぎ<br/>CartUpdated] --- Good(ちょうどよい<br/>CartItemAdded) --- Small[細かすぎ<br/>ItemQtyIncremented]
...
![Granularity Checklist](./picture/es_cs_study_008_granularity_checklist.png)
...
![Command Event Mirror](./picture/es_cs_study_008_cmd_evt_mirror.png)
...
![One Command Many Events](./picture/es_cs_study_008_one_to_many.png)
...
![C# Record Stamp](./picture/es_cs_study_008_record_stamp.png)
...
![Bad vs Good Naming](./picture/es_cs_study_008_bad_good_renovation.png)
