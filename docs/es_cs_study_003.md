...
![Good Subject Characteristics](./picture/es_cs_study_003_good_subject.png)
...
![なぜショッピングカートなの？](./picture/es_cs_study_003_selection.png)

### 1) 買い物カート🛒✨（いちばん王道）

![Shopping Cart Subject](./picture/es_cs_study_003_shopping_cart.png)
...
![ToDo List Subject](./picture/es_cs_study_003_todo_list.png)
...
![Bad Subjects](./picture/es_cs_study_003_bad_subjects.png)
...
![Requirement Limit](./picture/es_cs_study_003_requirement_limit.png)
...
![Command to Event](./picture/es_cs_study_003_command_event_pair.png)
...
```mermaid
graph LR
    subgraph CommandMap ["Command (〜したい)"]
        C1[Add]
        C2[Change]
        C3[Remove]
    end
    subgraph EventMap ["Event (〜した)"]
        E1[Added]
        E2[Changed]
        E3[Removed]
    end
    ...
    style CommandMap fill:#e1f5fe,stroke:#01579b
    style EventMap fill:#e8f5e9,stroke:#2e7d32
```
