...
![1. イベント粒度（Granularity）🔍🍰](./picture/gof_ts_study_062_granularity.png)
...
![2. イベント名（Naming）🏷️✨](./picture/gof_ts_study_062_naming.png)
...
![4. 互換性（壊れにくさ）🛡️🧸](./picture/gof_ts_study_062_compatibility.png)
...
![5. 同期配送の注意（リスナーの設計）🧵⚠️](./picture/gof_ts_study_062_sync_async.png)
