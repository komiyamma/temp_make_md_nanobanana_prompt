...
![バリデーションの置き場所](./picture/ddd_cs_study_039_validation.png)
...
```mermaid
flowchart TD
    Input["User Input 🗣️"] --> Boundary["① Boundary Check 🚪<br/>(Format, Required)"]
    Boundary -- OK --> Domain["② Domain Check 💎<br/>(Invariant, Rules)"]
    Domain -- OK --> Object["Valid Object ✅"]
    
    Boundary -- Fail --> Error1["UI Error 📝"]
    Domain -- Fail --> Error2["System Error / Exception 🧨"]
```
