...
![react_study_105_ref_prop](./picture/react_study_105_ref_prop.png)
...
* `ComponentPropsWithRef<"input">` の中に、
...
* ✅ TypeScript 的には `ComponentPropsWithRef<"input">` を使うとラク
...
* TypeScript では `ComponentPropsWithRef<"input">` を使うと
