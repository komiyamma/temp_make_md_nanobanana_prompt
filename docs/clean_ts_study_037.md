...
![clean_ts_study_037_mapper_absorber.png](./picture/clean_ts_study_037_mapper_absorber.png)🤔🔄
...
![clean_ts_study_037_pollution.png](./picture/clean_ts_study_037_pollution.png)（放置すると起きる悲劇）😱💥
...
![clean_ts_study_037_data_shapes.png](./picture/clean_ts_study_037_data_shapes.png)🧱📌
...
### 8) RepositoryではMapperだけを頼る

![clean_ts_study_037_repository_flow.png](./picture/clean_ts_study_037_repository_flow.png)🔌✨（超だいじ！）
...
![clean_ts_study_037_round_trip.png](./picture/clean_ts_study_037_round_trip.png)🧪💖（Round-trip最強）
