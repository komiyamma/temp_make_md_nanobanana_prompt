...
![Course Roadmap Mindmap](./picture/es_ts_index_roadmap_mindmap.png)
...
```mermaid
mindmap
  root((Event Sourcing<br/>Study Roadmap))
    Part 0: 準備と導入
      1: ゴールと進め方
      2: ESの基本概念
      3: 題材ドメイン決定
...
![Part 0 Preparation Toolbox](./picture/es_ts_index_part0_toolbox.png)
...
![Part 1 Core Foundation](./picture/es_ts_index_part1_foundation.png)
...
![Part 2 Implementation Loop](./picture/es_ts_index_part2_engine_loop.png)
...
![Part 3 Real World Obstacles](./picture/es_ts_index_part3_obstacle_course.png)
...
![Part 4 Projector Setup](./picture/es_ts_index_part4_projector_setup.png)
...
![Part 5 Graduation](./picture/es_ts_index_part5_graduation.png)
