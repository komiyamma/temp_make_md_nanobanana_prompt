...
1. **操作（Command）**：やりたいこと（意思）👆
   ...
   ![Command vs Fact](./picture/state_machine_cs_study_006_command_vs_fact.png)
...
![UI vs Business Event](./picture/state_machine_cs_study_006_ui_vs_business_event.png)
...
![Naming Rule Book](./picture/state_machine_cs_study_006_naming_rule_book.png)
...
![Event Argument Package](./picture/state_machine_cs_study_006_event_argument_package.png)
...
![Input Checklist](./picture/state_machine_cs_study_006_input_checklist.png)
